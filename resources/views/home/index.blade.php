                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="sponsors-area">
                      <div class="single">
                        <a class="" href="#"><img src="assets/img/sponsors/flowwlogo.png" alt="sponsor" /></a>
                      </div>
                      <div class="single">
        ...
        <div id="lgx-news" class="lgx-news">
          <div class="lgx-inner">
            <div class="container">
              ...
              <!-- xs kalo dikecilin jadi satu baris, sm jadi dua baris dan satu baris md dan md untuk full size-->
              <div class="row">
