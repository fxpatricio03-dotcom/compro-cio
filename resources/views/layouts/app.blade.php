...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- SITE TITLE -->
    <title>Portofolio Patricio</title>
    <meta name="description" content="Responsive Emeet HTML Template" />
    <!-- yg line 13 buat buka search engine operation (SAO) contentnya isi dari search-->
  ...
  <body class="home">
    ...
    <div class="lgx-container">
     ...
     <!-- cara manggilnya tinggal di pake aja tag nya sesuai namanya-->
      <!--FOOTER END-->
    </div>
    <!--//.LGX SITE CONTAINER-->
